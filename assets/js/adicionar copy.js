document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!dropdown || !selectedCategory || !tabelaCategoria || !formCategoria || !camposCategoria) {
...
document.addEventListener("DOMContentLoaded", function () {
    const dadosDiv = document.getElementById('meusDados');
        ...
        if (dadosPorTabela && typeof dadosPorTabela === 'object') {
            Object.keys(dadosPorTabela).forEach(tabela => {
                ...
                if (Array.isArray(dadosDaTabela) && dadosDaTabela.length > 0) {
                    ...
                    thAlteracoes.textContent = "Opções";
